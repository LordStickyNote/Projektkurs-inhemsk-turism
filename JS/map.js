...
const ownIcon = L.divIcon({
    className: "",
    html: `<svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
  <g opacity=".75">
    ...
    for (const item of section.items) {
        ...
        <span class="card-popup-content width-full">
          ...
          <span class="row row-between">
              ...
              <span class="row">
              <p>${Math.trunc(item.rating)}</p><svg class="star" aria-hidden="true" focusable="false" viewBox="0 0 16 16">
              <path
